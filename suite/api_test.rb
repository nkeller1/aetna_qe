...
class ApiTest < Minitest::Test
  ...
  it "test_successful_response_for_search_of_thomas" do
...
#
    it 'test_using_i_param_page_1_is_accessable_on_imbd' do
      make_request("?apikey=#{ENV['OMDB_API_KEY']}&s=thomas", 'http://www.omdbapi.com/')
      # puts last_response.body
      parse_last_response_body = JSON.parse(last_response.body)
      search_results =  parse_last_response_body['Search']
    ...
    it 'test_poster_link_validity_page_1' do
    ...
    it 'test_invalid_poster_links_are_okay_on_page_3' do
    ...
    it 'test_no_duplicate_records_across_first_5_pages' do
  ...
  # additional testing I am curious about
    it 'test_imbdID_is_uniform_for_all_responses_page_1' do
      make_request("?apikey=#{ENV['OMDB_API_KEY']}&s=thomas&page=1", 'http://www.omdbapi.com/')
      # puts last_response.body
      parse_last_response_body = JSON.parse(last_response.body)
      search_results =  parse_last_response_body['Search']
    ...
    it 'test_passing_no_query_params_throws_error' do
    ...
    it 'test_no_search_params_passed_throws_error' do
    ...
    it 'test_pass_in_nil_to_search_throws_error' do
      # This is sending a 200 response. I would probably ask that a differnt code be
      # sent instead of 200 for an error
    ...
    it 'test_nil_passed_as_api_key' do
    ...
    it 'test_total_results_key_exists_on_succcessful_response' do
      make_request("?apikey=#{ENV['OMDB_API_KEY']}&s=thomas", 'http://www.omdbapi.com/')
      # puts last_response.body
      parse_last_response_body = JSON.parse(last_response.body)
    ...
    it 'test_incorrect_datatypes_in_search_throws_error' do
      # This is sending a 200 response. I would probably ask that a differnt code be
      # sent instead of 200 for an error
    ...
    it 'test_passing_an_invalid_page_number_throws_error' do
      # This is sending a 200 response. I would probably ask that a differnt code be
      # sent instead of 200 for an error
    ...
    it 'test_passing_an_empty_search_throws_error' do
      # This is sending a 200 response. I would probably ask that a differnt code be
      # sent instead of 200 for an error
      make_request("?apikey=#{ENV['OMDB_API_KEY']}&s=", 'http://www.omdbapi.com/')
      # puts last_response.body
    ...
    it 'test_headers_are_as_expected' do
